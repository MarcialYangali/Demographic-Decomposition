...
datos_A <- build_structure(datos_base, version = "A")

# Joint structure version B: w_B = q * s_cond
datos_B <- build_structure(datos_base, version = "B")
